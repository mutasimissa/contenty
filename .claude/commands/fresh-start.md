...
10. Read `skills/website-init/SKILL.md`. Populate every route with content from the content deck, SEO metadata from the SEO brief, OG tags via `OGMeta` component, and JSON-LD via `JsonLd` component.
