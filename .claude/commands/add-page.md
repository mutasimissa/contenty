...
2. Ask the user for page name and type. Create a page brief at `business/07-page-briefs/<slug>.md` using the page-brief schema from `agency/schemas/page-brief.yaml`. Add the page to `business/06-sitemap.yaml` (primary or secondary navigation). If website is bootstrapped, create a route stub at `website/routes/<slug>.tsx`.
